...
export default function NotUserSideMenu() {
  const {
  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        <Button
          className="border-0 text-md !p-0 !bg-transparent hover:text-[#f2b90c] cursor-pointer"
          variant="outline"
        >
          로그인
        </Button>
      ...
      <SheetContent className="p-6 flex flex-col">
        ...
        <div className="space-y-4 flex-1">
          ...
          <div className="flex justify-center gap-2 text-sm">
            <a href="#" className="text-[#789EBF]">비밀번호 찾기</a>
            <a href="/signup" className="text-[#789EBF]">회원가입</a>
          </div>
          <button
            type="button"
