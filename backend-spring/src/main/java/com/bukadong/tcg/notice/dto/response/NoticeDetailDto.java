 ...
 * </p>
 */
public record NoticeDetailDto(Long id, String title, String text, Long authorId, String authorNickname, Long viewCount,
    ...
    public static NoticeDetailDto of(Notice n, List<NoticeAttachmentDto> files) {
        return new NoticeDetailDto(n.getId(), n.getTitle(), n.getText(), n.getAuthor().getId(),
                n.getAuthor().getNickname(), n.getViewCount(), n.getCreatedAt(), n.getUpdatedAt(), files);
    }
}
