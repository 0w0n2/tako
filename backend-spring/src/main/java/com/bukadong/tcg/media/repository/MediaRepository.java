package com.bukadong.tcg.media.repository;
 ...
 * 추가로 미디어 타입과 소유주(ownerId) 기준으로 조회하는 기능을 제공한다.
 * </p>
 */
public interface MediaRepository extends JpaRepository<Media, Long> {
     ...
     *
     * <p>
     * 예: 경매(AUCTION), 리뷰(REVIEW) 등 {@link MediaType}에 따라
     * 해당 소유주(ownerId)에 연결된 미디어를 순번(seqNo) 오름차순으로 정렬해 반환한다.
     * </p>
     *
