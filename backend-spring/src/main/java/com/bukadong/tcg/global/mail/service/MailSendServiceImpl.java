...
import com.bukadong.tcg.global.mail.provider.MailValueProvider;
...
public class MailSendServiceImpl implements MailSendService {
    ...
    public MailSendServiceImpl(JavaMailSender javaMailSender, List<MailValueProvider> providers) {
