...
public class DeliveryController {
    ...
    public BaseResponse<Delivery> setSender(@AuthenticationPrincipal CustomUserDetails user,
            @PathVariable long auctionId, @PathVariable long addressId) {
        var me = memberQueryService.getByUuid(user.getUuid());
    ...
    public BaseResponse<Delivery> setTracking(@AuthenticationPrincipal CustomUserDetails user,
            @PathVariable long auctionId, @RequestParam @NotBlank String trackingNumber) {
        var me = memberQueryService.getByUuid(user.getUuid());
    ...
    public BaseResponse<Void> confirm(@AuthenticationPrincipal CustomUserDetails user, @PathVariable long auctionId) {
        var me = memberQueryService.getByUuid(user.getUuid());
