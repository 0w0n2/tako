...
public record AuctionListItemResponse(
        @Schema(description = "경매 ID") Long id,
        @Schema(description = "카드 등급") String grade,
        @Schema(description = "경매 제목") String title,
        @Schema(description = "현재가") BigDecimal currentPrice,
        @Schema(description = "유효 입찰 수") long bidCount,
