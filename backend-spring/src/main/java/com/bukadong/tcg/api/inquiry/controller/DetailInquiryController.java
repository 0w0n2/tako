...
public class DetailInquiryController {
    ...
    private final Logger log = LoggerFactory.getLogger(DetailInquiryController.class);
    ...
    public BaseResponse<Void> update(@PathVariable("inquiryId") Long inquiryId,
            @Valid @RequestBody InquiryUpdateRequest request, @AuthenticationPrincipal CustomUserDetails user) {
    ...
    public BaseResponse<Void> delete(@PathVariable("inquiryId") Long inquiryId,
            @AuthenticationPrincipal CustomUserDetails user) {
        Member me = memberQueryService.getByUuid(user.getUuid());
    ...
    public BaseResponse<Long> createAnswer(@PathVariable("inquiryId") Long inquiryId,
            @Valid @RequestBody AnswerCreateRequest request, @AuthenticationPrincipal CustomUserDetails user) {
        Member me = memberQueryService.getByUuid(user.getUuid());
    ...
    @PatchMapping("/answers/{inquiryId}")
    public BaseResponse<Void> updateAnswer(@PathVariable("inquiryId") Long inquiryId,
            @Valid @RequestBody AnswerUpdateRequest request, @AuthenticationPrincipal CustomUserDetails user) {
        Member me = memberQueryService.getByUuid(user.getUuid());
    ...
    @DeleteMapping("/answers/{inquiryId}")
    public BaseResponse<Void> deleteAnswer(@PathVariable("inquiryId") Long inquiryId,
            @AuthenticationPrincipal CustomUserDetails user) {
        Member me = memberQueryService.getByUuid(user.getUuid());
