...
public record UpdateMyProfileRequest(
        ...
        @Schema(description = "알림 설정: code별 0/1", example = "{\"WISH_AUCTION_STARTED\":1,\"WISH_AUCTION_DUE_SOON\":1}, \"WISH_AUCTION_ENDED\":1}") Map<String, Integer> notificationSetting // key:
